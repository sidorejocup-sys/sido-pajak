<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah Subjek Pajak</h2>
                <p class="text-sm text-gray-500">Lengkapi identitas wajib pajak untuk pencatatan Bumi dan Bangunan.</p>
            </div>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('subjek-pajak.store') }}" class="space-y-4">
                    @csrf
